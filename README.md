...
This data is MacDonald review data obatined from kaggle (https://www.kaggle.com/datasets/arnavs19/mcdonalds-reviews/data). The data includes response regarding taste, health, cost and efficiency. Further, it also includes responders age, visit frequency and ratings. In this report, I have analyzed the important determinant of MacDonald like and visit frequency. Further, I have also reported perception of respondent on various features related to taste, cost, efficiency and health. Overall, the respondent seemed satisfied on taste, cost and efficiency related features. However, the response was mostly negative toward health related features. The age-based analysis of the response suggested that younger population had positive response toward food taste however, the response was reversed for older population (no for "yummy"). Higher percentage of respondent for all age-group except 41-45 years commented food as being cheap and not expensive. Most of the respondent on all age-group commented the restaurant as fast and convenient. For all age-group, higher percentages of respondent commented food as unhealthy and fattening. The visit frequency and age had a significant impact on the like/rating. The average like/rating for respondent who visited >52 times a year was highest (3.8) whereas average like/rating for respondent who never visited the restaurant was lowest (-3.91). Similarly, younger age-group respondent (< 40 years) gave higher like/rating compared to respondent at age-group (>40 years). The age-group 21-25 years gave the highest rating (2.4) whereas age-group 61-65 years gave the lowest rating (-0.3). Although, female gave higher like/rating (0.9) than male (0.6) the differences was not statistically significant. The taste related feature “yummy" was the most important predictor for both like and visit frequency.  “Convenient" was the second most important predictor of visit frequency but the fourth most important predictor of like/Rating.  Although health related predictor "greasy" was the 5th most important predictor for both like and visit frequency, another health-related feature "healthy" was 6th most important feature for like whereas it was 9th most important feature for visit frequency. Hence, based in these results it can be suggested that older population are not satisfied with food taste (no yummy), which may be one of the reasons behind less visit frequency and like/rating. The restaurant may need to study the taste preferences of the older population and include those as food options to attract the customers of all age-groups. Further, the response regarding health-related features was negative. Although health was not one of the most important predictors of like and visit frequency, it has potential to be important predictors in future as people are becoming aware of their health, fitness, and diet. The restaurant can include food that is both yummy and healthy and study its impact on like, visit frequency and ability to attract wide range of customers. Overall, at present the restaurant seems less popular among the older population and hence may need to work on improving taste to attract these groups as well. Further, there is an increase in awareness among people about their health, hence unsatisfied response toward health related feature could negatively impact restaurant performance in future. Hence, the restaurant may need to investigate and provide healthier and tastier food options. 

**Methodology**

The data were analyzed using python in spyder (https://www.spyder-ide.org/). The code for data cleaning and each analysis are provided as separate file with their respective name. The code for data cleaning and validation need to be ran first before running code for the analysis.
...
The columns were categorized as features related to taste, cost and efficiency and health. The taste related features were “Yummy”, “Tasty”, “Spicy” and “Disgusting”. The cost and efficiency related features were “Cheap”, “Expensive”, “Fast” and “Convenient”. The health-related features were “Healthy”, “Fattening” and “Greasy”. The overall response analysis suggested that the responders are comparatively satisfied with features related to taste and cost and efficiency; however, they are not satisfied with features related to health (Figure 2,3 and 4). Higher percentages of respondents commented to positive taste related features as Yes (yummy: 55.23% and Tasty: 64.39%) and negative taste related features as No (Spicy: 90.63%, Disgusting: 75.69%) (Figure 2). Similarly higher percentages of respondents commented the restaurant to be cheaper, fast, and convenient (yes %: cheap (59.85%), expensive (35.81%), fast (90.01%), convenient (90.77%)). Higher percentages of respondent commented the food to be unhealthy, fattening, and greasy (yes %: healthy (19.9%), fattening (86.71%), greasy (52.62%)). 
...
Percentage distribution of response regarding food taste based on age-group showed that age-group below 45 years feel food as yummy but the result was reversed for age group above 45 years (Figure 5A). Similarly, higher percentages of respondent commented food as Tasty; however the "yes" percentages was lower for older population compared to younger population (Figure 5B). Most of the respondent commented food as not being spicy and disgusting (Figure 5C and D). Higher percentage of respondent for all age-group except 41-45 years commented food as being cheap and not expensive (Figure 6A and B). Most of the respondent on all age-group commented the restaurant as fast and convenient (Figure 6C and D). For all age-group, higher percentages of respondent commented food as unhealthy and fattening (Figure 7a and B). 
...
Figure 6. Percentage distribution of response regarding food cost and efficiency based on age-group. Higher percentage of respondent for all age-group except 41-45 years commented food as being cheap (A). Similarly, higher percentage of respondent of all age-group except 41-45 years commented "no" for food being expensive (B). Most of the respondent on all age-group commented the restaurant as fast and convenient (C and D). 
...
The median age for the respondent was significantly lower for the respondent who visited the restaurant more often (Figure 8). The median age of respondent who never visited the restaurant was 55 whereas the median age of the respondent who visited more than 52 times a year was 33 (Figure 8). The median age of respondent who visited few times or never (0, 1, 4 times as year) was significantly lower than the respondent who visited more frequently (12, 52 and > 52 times a year) (Mann-whitney test, sig (p<=0.05)). Most of the respondent visited restaurant 12 times a year (Figure 9). Similarly, most of the respondent in age group 16- 50 years and > 65 years visited the restaurant 12 times a year whereas most of the respondent in the age-group 51-65 years visited the restaurant 4 times a year (Figure 10). Highest number of visit frequency for both male and female was 12 times a year (Figure 10). 
...
Figure 10. Relative percentages of number of visits based on A) age-group and B) gender. Most of the respondent in age-group 16-50 years (>30%) and > 65 years (28%) visited the restaurant 12 times a year. Most of the respondent in age-group 51-65 years (29%) visited the restaurant 4 times a year. Similarly, for both gender the highest visit frequency was 12 times a year (>30%). The relative percentage of respondent was least (<5%) for visit frequency > 52 times a year for age group 16-20 and >31 years. For age-group 21-30 least percentages of respondent (<5%) never visited the restaurant. Similarly, for both gender the lowest visit frequency was >52 times a year (< 5%). 


**Does age, gender and visit frequency impact like/rating?**

The visit frequency and age had a significant impact on the like/rating. The average like/rating significantly increase with an increase in visit frequency (pairwise_tukeyhsd, sig (p-value<=0.05)) (Figure 11 A). The average like/rating for respondent who visited >52 times a year was highest (3.8) whereas average like/rating for respondent who never visited the restaurant was lowest (-3.91) (Figure 11 A). Similarly, younger age-group respondent (< 40 years) gave higher like/rating compared to respondent at age-group (>40 years) (Figure 12A). The age-group 21-25 years gave the highest rating (2.4) whereas age-group 61-65 years gave the lowest rating (-0.3) (Figure 12A). The lowest average like/rating given by age-group 61-65 years was significantly different than average like/rating given by age-group <40 years (Figure 12A). Although, female gave higher like/rating (0.9) than male (0.6) the differences was not statistically significant (pairwise_tukeyhsd, sig (p-value<=0.05)) (Figure 12B). A very high percentages of respondent (63%) who never visited the restaurant gave -5 for like/rating (Figure 11B). Similarly, highest percentage of respondent (44%) who visted the restaurant >52 times a year gave 5 like/rating (Figure 11B). This suggested that respondent who visited more are more likely to give higher like/rating. 

Highest percentage (>20%) of younger age group (16-25 years) gave rating 5 whereas highest percentage of respondent (>15%) in age group greater than 61 years gave rating -5 (Figure 13A). This suggest that younger generation like the restaurant more than older populations. The relative percentages shows decline in like/rating with age (Figure 13A). For both male (14%) and female (17%), most of the respondent gave rating 3 (Figure 13B).    
...
The important predictors (food related) for like and visit frequency were determined using random forest. The results showed that "yummy" was the most important predictor for both like and visit frequency (Figure 14 and 15). Taste related features were the top most determinant of both like and visit frequency (3 out of top 4) (Figure 14 and 15) . The "convenient" was the second most important predictor of visit frequency but the fourth most important predictor of like/Rating (Figure 14 and 15). Although health related predictor "greasy" was 5th most important predictor for both like and visit frequency, another health related feature "healthy" was 6th most important feature for like whereas it was 9th most important feature for visit frequency (Figure 14 and 15). The cost related feature "cheap" and "expensive" ranked as 7th and 8th most important feature respectively for like whereas 8th and 6th most important feature respectively for visit frquency (Figure 14 and 15).  
...
Hence, based in these results it can be suggested that older population are not satisfied with food taste (no yummy), which may be one of the reasons behind less visit frequency and like/rating. The restaurant may need to study the taste preferences of the older population and include those as food options to attract the customers of all age-groups. Further, the response regarding health related features was negative. Although health was not one of the most important predictors of like and visit frequency, it has potential to be important predictors in future as people are becoming aware of their health, fitness, and diet. The restaurant can include food that is both yummy and healthy and study its impact on like, visit frequency and ability to attract wide range of customers. The respondent were satisfied with efficiency of the restaurant. Higher percentages of respondent in all age-group except 41-45 years commented the food to be cheap. There could be several possible reasons for this discrepancy. This age can be one of the stage where an individual bears higher economic burden that can range from fulfilling responsibilities from past to future (for example, an individual may be paying earlier student loans, fulfilling current family economic responsibilities and saving for future). Hence, the price of the food may not be considered cheap by this age-group. Overall, at present the restaurant seems less popular among the older population and hence may need to work on improving taste to attract these groups as well. Further, there is an increase in awareness among people about their health, hence unsatisfied response toward health related feature could negatively impact restaurant performance in future. Hence, the restaurant may need to investigate and provide healthier and tastier food options. 
